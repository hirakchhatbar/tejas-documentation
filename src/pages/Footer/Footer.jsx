...
const FOOTER_DOC_KEYS = ['installation', 'hello-world', 'routing', 'api-reference']

const footerDocLinks = sidebarGroups.flatMap((g) => g.items)
  .filter((item) => item.componentKey && !item.comingSoon && FOOTER_DOC_KEYS.includes(item.componentKey))
